...
private slots:
    ...
    QString BuyDMN(QString OrderType, double Quantity, double Rate);
    QString SellDMN(QString OrderType, double Quantity, double Rate);
